...
$(function() {
    ...
    $(document).on('click', '.event', function (){
        ...
        $('#modalFastEvent').modal('show');
        $('#modalFastEvent #titleModal').text('Edit Quick Event');
    ...
    $('.saveFastEvent').click(function() {
        ...
        let start = moment($("#modalFastEvent input[name='start']").val(), 'THH:mm').format('HH:mm:ss');

        let end = moment($("#modalFastEvent input[name='end']").val(), 'THH:mm').format('HH:mm:ss');
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if(showModalUpdateFastEvent === true) {
                ...
                $(`#boxFastEvents${data_.id}`).attr('data-event', stringJson);
                $(`#boxFastEvents${data_.id}`).text(data_.title);
                $(`#boxFastEvents${data_.id}`).css({
