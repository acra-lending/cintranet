            ...
            <div class="card-body">
                ...
                <nav aria-label="announcements-pages">
                    <ul class="pagination pagination-sm justify-content-end">
                      ...
                      <li class="page-item disabled"><a class="page-link" href="/learning/announcements2">2</a></li>
                ...
                <div class="callout callout-danger">
                <h5>The Taxpayer First Act - Account Executives, Loan Set-up</h5>
                ...
                <table class="table">
                    <tbody>
                      <tr>
                        <td>
                          General Announcements Number 01-001
                        </td>
                        <td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="#" class="text-muted"><i class="fas fa-file-alt"></i></a>
                ...
                <div class="callout callout-danger">
                <h5>New PTD condition for South Carolina Files - QC, Transaction Managers, Doc Drawers, Underwriting and Funders</h5>
                ...
                <table class="table">
                    <tbody>
                      <tr>
                        <td>
                          General Announcements Number 12-009
                        </td>
                        <td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="#" class="text-muted"><i class="fas fa-file-alt"></i></a>
                ...
                <div class="callout callout-danger">
                <h5>Addition to Email Signature Line - All CSC employees</h5>
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>
                          General Announcements Number 12-008
                        </td>
                        <td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <a href="#" class="text-muted"><i class="fas fa-file-alt"></i></a>
