              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                  <div class="tab-content" id="vert-tabs-tabContent">
                    ...
                    <div class="tab-pane fade" id="vert-tabs-dscr" role="tabpanel" aria-labelledby="vert-tabs-dscr-tab">
                      <!-- /.content-header -->        
                      <div class="col">
                        <div class="card card-danger">
                          <div class="card-header border-0">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                  <div class="tab-content" id="vert-tabs-tabContent">
                    ...
                    <div class="tab-pane fade" id="vert-tabs-dscr-corr" role="tabpanel" aria-labelledby="vert-tabs-dscr-corr-tab">
                      <!-- /.content-header -->        
                      <div class="col">
                        <div class="card card-danger">
                          <div class="card-header border-0">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                  <div class="tab-content" id="vert-tabs-tabContent">
                    ...
                    <div class="tab-pane fade" id="vert-tabs-dscr_past" role="tabpanel" aria-labelledby="vert-tabs-dscr-tab_past" wire:ignore.self>
                      <!-- /.content-header -->        
                      <div class="col">
                        <div class="card card-danger">
                          <div class="card-header border-0">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                  <div class="tab-content" id="vert-tabs-tabContent">
                    ...
                    <div class="tab-pane fade" id="vert-tabs-dscr-corr_past" role="tabpanel" aria-labelledby="vert-tabs-dscr-corr-tab_past" wire:ignore.self>
                      <!-- /.content-header -->        
                      <div class="col">
                        <div class="card card-danger">
                          <div class="card-header border-0">
