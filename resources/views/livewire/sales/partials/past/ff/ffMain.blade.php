<div class="tab-pane fade show active" id="vert-tabs-ild-main_past" role="tabpanel" aria-labelledby="vert-tabs-ild-main_past-tab">      
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Main Rate Sheet</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              @if(!empty($ffMain_past))
              @foreach($ffMain_past as $category) 
                <tr>
