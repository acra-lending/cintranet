<div class="tab-pane fade" id="vert-tabs-ff-stabilized-bridge-bf_past" role="tabpanel" aria-labelledby="vert-tabs-ff-stabilized-bridge-bf-tab_past" wire:ignore.self>      
    <div class="col">
      <div class="card card-danger">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              @foreach($ffFamily_past as $category) 
                <tr>
