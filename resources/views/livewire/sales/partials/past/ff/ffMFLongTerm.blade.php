<div class="tab-pane fade" id="vert-tabs-ild-mf-long-term_past" role="tabpanel" aria-labelledby="vert-tabs-ild-mf-long-term_past-tab">      
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Multifamily Long Term</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
            @if(!empty($ffMultiFamilyLongTerm_past))
            @foreach($ffMultiFamilyLongTerm_past as $category) 
              <tr>
