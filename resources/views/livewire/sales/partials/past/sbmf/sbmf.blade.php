<div class="tab-pane fade" id="vert-tabs-small-balance-multifamily_past" role="tabpanel" aria-labelledby="vert-tabs-small-balance-multifamily-tab_past" wire:ignore.self>     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Small Balance Multifamily</h3>
