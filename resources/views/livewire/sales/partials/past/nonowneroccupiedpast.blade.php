<div class="tab-pane fade" id="vert-tabs-non-owner-occupied_past" role="tabpanel" aria-labelledby="vert-tabs-non-owner-occupied-tab_past" wire:ignore.self>     
    <div class="col">
      <div class="card card-danger">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              @foreach($nonOwnerOccu_past as $category)
