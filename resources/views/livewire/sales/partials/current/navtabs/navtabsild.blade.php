<div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link active" id="vert-tabs-ild-main-tab" data-toggle="pill" href="#vert-tabs-ild-main" role="tab" aria-controls="vert-tabs-ild-main" aria-selected="false">Main Sheet</a>
    ...
    <a class="nav-link" id="vert-tabs-ild-mf-bridge-tab" data-toggle="pill" href="#vert-tabs-ild-mf-bridge" role="tab" aria-controls="vert-tabs-ild-mf-bridge" aria-selected="false">MF Bridge</a>
