<div class="tab-pane fade" id="vert-tabs-ff-stabilized-bridge" role="tabpanel" aria-labelledby="vert-tabs-ff-stabilized-bridge-tab">      
    <div class="col">
      <div class="card card-danger">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              @if(!empty($ffSingleFamily))
              @foreach($ffSingleFamily as $category) 
                <tr>
            ...
            @if(!empty($ffMultiFamily))
            @foreach($ffMultiFamily as $category) 
              <tr>
              <td>{{$category->filename}}</td>
              <td>{{($category->filesize)}} KB</td>
              <td>{{ Carbon\Carbon::parse($category->created_at)->format('m-d-Y') }}</td>
