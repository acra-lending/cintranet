<div class="tab-pane fade" id="vert-tabs-ild-nonowneroccu" role="tabpanel" aria-labelledby="vert-tabs-ild-nonowneroccu-tab">      
    <div class="col">
      <div class="card card-danger">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              @if(!empty($ffNonOwnerOccu))
              @foreach($ffNonOwnerOccu as $category) 
                <tr>
