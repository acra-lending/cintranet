<div class="tab-pane fade" id="vert-tabs-ild-mf-long-term" role="tabpanel" aria-labelledby="vert-tabs-ild-mf-long-term-tab">      
    <div class="col">
      <div class="card card-danger">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
            @if(!empty($ffMultiFamilyLongTerm))
            @foreach($ffMultiFamilyLongTerm as $category) 
              <tr>
