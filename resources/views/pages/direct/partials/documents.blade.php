...
<div class="tab-pane fade show active" id="nav-documents" role="tabpanel" aria-labelledby="nav-documents-tab">
    <div class="row">
        ...
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" id="vert-tabs-docs-tab" data-toggle="pill" href="#vert-tabs-docs" role="tab" aria-controls="vert-tabs-docs" aria-selected="true">Documents</a>
            <a class="nav-link" id="vert-tabs-mlo-tab" data-toggle="pill" href="#vert-tabs-mlo" role="tab" aria-controls="vert-tabs-mlo" aria-selected="true">MLO Licenses</a>
        </div>
        </div>
        <div class="col-sm-10">
        <div class="tab-content" id="vert-tabs-tabContent">
            <div class="tab-pane text-left fade show active" id="vert-tabs-docs" role="tabpanel" aria-labelledby="vert-tabs-docs-tab">       
            <div class="col">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <tbody>
                        @foreach($retailDocs as $category)
                        <tr>
            ...
            <div class="tab-pane fade" id="vert-tabs-mlo" role="tabpanel" aria-labelledby="vert-tabs-mlo-tab">
