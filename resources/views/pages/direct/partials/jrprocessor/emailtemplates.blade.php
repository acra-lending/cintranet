<div class="tab-pane text-left fade" id="vert-tabs-jr-processor-email-templates" role="tabpanel" aria-labelledby="vert-tabs-jr-processor-email-templates-tab">       
    <div class="col">
        ...
        <div class="card-body table-responsive p-0">
            ...
            <tbody>
                @foreach($retailJrProcessorEmailTemplates as $category)
                <tr>
