<div class="tab-pane fade show" id="nav-collateral" role="tabpanel" aria-labelledby="nav-collateral-tab">
    <div class="row">
      <div class="col-sm-2">
      ...
      <div class="col-sm-10">
        <div class="tab-content" id="vert-tabs-tabContent">
          ...
          <div class="tab-pane text-left fade show active" id="vert-tabs-email-templates" role="tabpanel" aria-labelledby="vert-tabs-email-templates-tab">       
            <div class="col">
              <div class="card card-dark ">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($retailEmailTemplates as $category)
                        <tr>
