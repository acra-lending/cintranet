...
<div class="tab-pane fade show" id="nav-loan-officer" role="tabpanel" aria-labelledby="nav-loan-officer-tab">
    <div class="row">
        ...
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" id="vert-tabs-loan-officer-forms-tab" data-toggle="pill" href="#vert-tabs-loan-officer-forms" role="tab" aria-controls="vert-tabs-loan-officer-forms" aria-selected="true">Forms</a>
            <a class="nav-link" id="vert-tabs-loan-officer-checklists-tab" data-toggle="pill" href="#vert-tabs-loan-officer-checklists" role="tab" aria-controls="vert-tabs-loan-officer-checklists" aria-selected="true">Checklists</a>
            <a class="nav-link" id="vert-tabs-loan-officer-training-tab" data-toggle="pill" href="#vert-tabs-loan-officer-training" role="tab" aria-controls="vert-tabs-loan-officer-training" aria-selected="true">Training</a>
        </div>
        </div>
        <div class="col-sm-10">
        <div class="tab-content" id="vert-tabs-tabContent">
            ...
            <div class="col">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <tbody>
                        @foreach($retailLoanOfficerChecklists as $category)
                        <tr>
                        <td>{{$category->filename}}</td>
                        <td>{{$category->filesize}} KB</td>
                        <td>{{ Carbon\Carbon::parse($category->created_at)->format('m-d-Y') }}</td>
            ...
            <div class="tab-pane fade" id="vert-tabs-loan-officer-training" role="tabpanel" aria-labelledby="vert-tabs-loan-officer-training-tab">
            ...
            <div class="col">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <tbody>
                        @foreach($retailLoanOfficerTraining as $category)
                        <tr>
                        <td>{{$category->filename}}</td>
                        <td>{{$category->filesize}} KB</td>
                        <td>{{ Carbon\Carbon::parse($category->created_at)->format('m-d-Y') }}</td>
