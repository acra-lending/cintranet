<div class="tab-pane fade" id="vert-tabs-processor-system-guides" role="tabpanel" aria-labelledby="vert-tabs-processor-system-guides-tab">
    <div class="col">
        <div class="card card-dark ">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    @foreach($retailSystemGuides as $category)
                    <tr>
