<div class="tab-pane fade" id="vert-tabs-processor-tools" role="tabpanel" aria-labelledby="vert-tabs-processor-tools-tab">
    <div class="col">
        <div class="card card-dark ">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    @foreach($retailProcessorTools as $category)
                    <tr>
