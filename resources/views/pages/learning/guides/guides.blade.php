    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="/learning/guides">Learning</a></li>
                ...
                <div class="row">
                  <div class="col-sm-2">
                    <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                      ...
                      <a class="nav-link" id="vert-tabs-jumbo-prime-tab" data-toggle="pill" href="#vert-tabs-jumbo-prime" role="tab" aria-controls="vert-tabs-jumbo-prime" aria-selected="false">Jumbo Prime</a>
                    </div>
                  </div>
                  <!-- Guides Content -->
                  <div class="col-sm-10">
                    <div class="tab-content" id="vert-tabs-tabContent">
                      ...
                      <div class="tab-pane fade" id="vert-tabs-jumbo-prime" role="tabpanel" aria-labelledby="vert-tabs-jumbo-prime-tab">
                        <!-- /.content-header -->        
                        <div class="col">
                          <div class="card card-danger">
                            <div class="card-header border-0">
                            ...
                            <div class="card-body table-responsive p-0">
                              <table class="table">
                                ...
                                <tbody>
                                    @if(count($jumboPrimeGuides) > 0)
                                    @foreach($jumboPrimeGuides as $category)
                                    <tr>
                                    <td>{{$category->filename}}</td>
                                    <td>{{$category->filesize}} KB</td>
                                    <td>{{ Carbon\Carbon::parse($category->created_at)->format('m-d-Y') }}</td>
