<div class="tab-pane fade" id="vert-tabs-draw-forms" role="tabpanel" aria-labelledby="vert-tabs-draw-forms-tab">       
  <div class="col">
    <div class="card card-dark ">
      <div class="card-header border-0">
        <h3 class="card-title">Draw Forms</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
              @foreach($fixAndFlipDrawForms as $category)
              <tr>
