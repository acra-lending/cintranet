      ...
      <div class="card-body box-profile">
        <div class="">
          ...
          <p class="text-muted text-center">
            <a href="mailto:pod4@acralending.com">pod4@acralending.com</a>
          </p>
            @foreach ($pod4Tms as $podTm)
            <div class="center">
                <h3 class="profile-username highlight">
                    TM Team {{ $podTm['name'] }}
                </h3>
            </div>
                @foreach ($pod4TmUsers as $user)
                ...
                @endforeach
            @endforeach
            @foreach ($pod4Uws as $podUw)
            <div class="center">
                <h3 class="profile-username highlight">
                    UW Team {{ $podUw['name'] }}
                </h3>
            </div>
                @foreach ($pod4UwUsers as $user)
