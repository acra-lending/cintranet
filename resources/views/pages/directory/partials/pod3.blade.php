      ...
      <div class="card-body box-profile">
        <div class="">
          ...
          <p class="text-muted text-center">
            <a href="mailto:pod3@acralending.com">pod3@acralending.com</a>
          </p>
            @foreach ($pod3Tms as $podTm)
            <div class="center">
                <h3 class="profile-username highlight">
                    TM Team {{ $podTm['name'] }}
                </h3>
            </div>
                @foreach ($pod3TmUsers as $user)
                ...
                @endforeach
            @endforeach
            @foreach ($pod3Uws as $podUw)
            <div class="center">
                <h3 class="profile-username highlight">
                    UW Team {{ $podUw['name'] }}
                </h3>
            </div>
                @foreach ($pod3UwUsers as $user)
