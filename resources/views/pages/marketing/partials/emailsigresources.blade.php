<div class="tab-pane fade" id="nav-email-resources" role="tabpanel" aria-labelledby="nav-email-resources-tab">
    <div class="card-body">
        <!-- /.card-header -->
        ...
        <div class="col">
            ...
            <div class="card-header border-0">
                <h3 class="card-title">Email Signatures & Resources</h3>
            ...
            <div class="card-body table-responsive p-0">
                ...
                <tbody>
                    @if(count($marketingEmailSignaturesAndResources) > 0)
                    @foreach($marketingEmailSignaturesAndResources as $category)
                    <tr>
