<div class="tab-pane fade" id="vert-tabs-closing-funding" role="tabpanel" aria-labelledby="vert-tabs-closing-funding-tab">      
  <div class="col">
    <div class="card card-dark">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($empowerClosingFunding) > 0 )
              @foreach($empowerClosingFunding as $category)
              <tr>
