<div class="tab-pane fade" id="vert-tabs-post-closing" role="tabpanel" aria-labelledby="vert-tabs-post-closing-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Post-Closing</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($empowerPostClosing) > 0 )
              @foreach($empowerPostClosing as $category)
              <tr>
