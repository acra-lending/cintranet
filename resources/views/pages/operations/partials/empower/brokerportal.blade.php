<div class="tab-pane fade show active" id="vert-tabs-broker-portal" role="tabpanel" aria-labelledby="vert-tabs-broker-portal-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Broker Portal</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($empowerBrokerPortal) > 0 )
              @foreach($empowerBrokerPortal as $category)
              <tr>
