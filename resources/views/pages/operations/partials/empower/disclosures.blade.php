<div class="tab-pane fade" id="vert-tabs-disclosures" role="tabpanel" aria-labelledby="vert-tabs-disclosures-tab">      
  <div class="col">
    <div class="card card-dark">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($empowerDisclosures) > 0 )
              @foreach($empowerDisclosures as $category)
              <tr>
