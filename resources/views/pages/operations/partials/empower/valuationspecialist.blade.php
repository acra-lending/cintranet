<div class="tab-pane fade" id="vert-tabs-valuation-specialist" role="tabpanel" aria-labelledby="vert-tabs-valuation-specialist-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Valuation Specialist</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table"> 
          ...
          <tbody>
            @if(count($empowerValuationSpecialist) > 0 )
              @foreach($empowerValuationSpecialist as $category)
              <tr>
