    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="vert-tabs-fix-and-flip-uw-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-uw" role="tab" aria-controls="vert-tabs-fix-and-flip-uw" aria-selected="true">ILD UW</a>
          <a class="nav-link" id="vert-tabs-fix-and-flip-funding-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-funding" role="tab" aria-controls="vert-tabs-fix-and-flip-funding" aria-selected="true">ILD Closing/Funding</a>
