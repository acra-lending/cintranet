    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="vert-tabs-fix-and-flip-vetting-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-vetting" role="tab" aria-controls="vert-tabs-fix-and-flip-vetting" aria-selected="true">Agent Verification</a>
          <a class="nav-link" id="vert-tabs-fix-and-flip-intake-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-intake" role="tab" aria-controls="vert-tabs-fix-and-flip-intake" aria-selected="true">Loan Set Up</a>
          ...
          <a class="nav-link" id="vert-tabs-fix-and-flip-uw-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-uw" role="tab" aria-controls="vert-tabs-fix-and-flip-uw" aria-selected="true">Fix & Flip UW</a>
          <a class="nav-link" id="vert-tabs-fix-and-flip-funding-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-funding" role="tab" aria-controls="vert-tabs-fix-and-flip-funding" aria-selected="true">Fix & Flip Closing/Funding</a>
          <a class="nav-link" id="vert-tabs-fix-and-flip-vendor-contacts-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-vendor-contacts" role="tab" aria-controls="vert-tabs-fix-and-flip-vendor-contacts" aria-selected="true">Vendor Contacts</a>
        ...
        <div class="tab-content" id="vert-tabs-tabContent">
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-fix-and-flip-uw" role="tabpanel" aria-labelledby="vert-tabs-fix-and-flip-uw-tab">
            ...
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Fix & Flip UW</h3>
                  <div class="card-tools">
                    </a>
                  </div>
                </div>
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-fix-and-flip-funding" role="tabpanel" aria-labelledby="vert-tabs-fix-and-flip-funding-tab">
            ...
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Fix & Flip Closing/Funding</h3>
                  <div class="card-tools">
                    </a>
                  </div>
                </div>
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-fix-and-flip-vendor-contacts" role="tabpanel" aria-labelledby="vert-tabs-fix-and-flip-vendor-contacts-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($fixAndFlipVendorContacts as $category)
                        <tr>
                          <td>{{$category->filename}}</td>
                          <td>{{$category->filesize}} KB</td>
                          <td>{{ Carbon\Carbon::parse($category->updated_at)->format('m-d-Y') }}</td>
