    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-fix-and-flip-intake-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip-intake" role="tab" aria-controls="vert-tabs-fix-and-flip-intake" aria-selected="true">Intake</a>
      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-fix-and-flip-intake" role="tabpanel" aria-labelledby="vert-tabs-fix-and-flip-intake-tab">
            <!-- /.content-header -->        
            <div class="col">
