<div class="tab-pane fade show" id="nav-prescreen" role="tabpanel" aria-labelledby="nav-prescreen-tab">
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-prescreen-tab" data-toggle="pill" href="#vert-tabs-prescreen" role="tab" aria-controls="vert-tabs-prescreen" aria-selected="true">Pre-Screen</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-prescreen" role="tabpanel" aria-labelledby="vert-tabs-prescreen-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Pre-Screen</h3>
