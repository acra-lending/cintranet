    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-jr-processor-forms-tab" data-toggle="pill" href="#vert-tabs-jr-processor-forms" role="tab" aria-controls="vert-tabs-jr-processor-forms" aria-selected="true">Internal Forms</a>
          <a class="nav-link" id="vert-tabs-jr-processor-vendor-contacts-tab" data-toggle="pill" href="#vert-tabs-jr-processor-vendor-contacts" role="tab" aria-controls="vert-tabs-jr-processor-vendor-contacts" aria-selected="true">Vendor Contacts</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
              ...
              <div class="card card-dark">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($jrProcessorForms as $category)
                        <tr>
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-jr-processor-vendor-contacts" role="tabpanel" aria-labelledby="vert-tabs-jr-processor-vendor-contacts-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($jrProcessorVendorContacts as $category)
                        <tr>
                          <td>{{$category->filename}}</td>
                          <td>{{$category->filesize}} KB</td>
                          <td>{{ Carbon\Carbon::parse($category->updated_at)->format('m-d-Y') }}</td>
