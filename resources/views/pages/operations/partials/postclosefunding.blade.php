<div class="tab-pane fade show" id="nav-post-close-funding" role="tabpanel" aria-labelledby="nav-post-close-funding-tab">
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-post-close-funding-tab" data-toggle="pill" href="#vert-tabs-post-close-funding" role="tab" aria-controls="vert-tabs-post-close-funding" aria-selected="true">Post Close-Funding</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-post-close-funding" role="tabpanel" aria-labelledby="vert-tabs-post-close-funding-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Post Close-Funding</h3>
