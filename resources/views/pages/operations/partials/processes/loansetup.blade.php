<div class="tab-pane fade" id="vert-tabs-lsu" role="tabpanel" aria-labelledby="vert-tabs-lsu-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Loan Set Up processes</h3>
      </div>
