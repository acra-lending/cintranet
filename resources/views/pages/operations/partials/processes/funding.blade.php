<div class="tab-pane fade show active" id="vert-tabs-funding" role="tabpanel" aria-labelledby="vert-tabs-funding-tab">      
    <div class="col">
      <div class="card card-dark">
        <div class="card-header border-0">
          <h3 class="card-title">Funding Processes</h3>
        </div>
