<div class="tab-pane fade" id="vert-tabs-doc" role="tabpanel" aria-labelledby="vert-tabs-doc-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">CD Doc Drawer Processes</h3>
      </div>
