<div class="tab-pane fade" id="vert-tabs-funder" role="tabpanel" aria-labelledby="vert-tabs-funder-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Funder-CLoser Processes</h3>
      </div>
