<div class="tab-pane fade" id="vert-tabs-fix-and-flip" role="tabpanel" aria-labelledby="vert-tabs-fix-and-flip-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Fix And Flip Processes</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($fixAndFlipProcessing) > 0 )
