<div class="tab-pane fade" id="vert-tabs-funding-asst" role="tabpanel" aria-labelledby="vert-tabs-funding-asst-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Funding Assistant Processes</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table"> 
          ...
          <tbody>
            @if(count($fundingAssistantProcesses) > 0 )
