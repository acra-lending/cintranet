<div class="tab-pane fade" id="vert-tabs-funding-forms" role="tabpanel" aria-labelledby="vert-tabs-funding-forms-tab">      
  <div class="col">
    <div class="card card-dark">
      <div class="card-header border-0">
        <h3 class="card-title">Funding Forms Processes</h3>
      </div>
      <div class="card-body table-responsive p-0">
        <table class="table">
          ...
          <tbody>
            @if(count($fundingFormsProcesses) > 0 )
