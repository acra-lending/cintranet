<div class="tab-pane fade show" id="nav-valuations" role="tabpanel" aria-labelledby="nav-valuations-tab">
    <div class="row">
      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-valuations" role="tabpanel" aria-labelledby="vert-tabs-valuations-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($valuations as $category)
                        <tr>
