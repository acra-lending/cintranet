<div class="tab-pane fade show" id="nav-vetting-clerk" role="tabpanel" aria-labelledby="nav-vetting-clerk-tab">
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-vetting-clerk-tab" data-toggle="pill" href="#vert-tabs-vetting-clerk" role="tab" aria-controls="vert-tabs-vetting-clerk" aria-selected="true">Vetting Clerk</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-vetting-clerk" role="tabpanel" aria-labelledby="vert-tabs-vetting-clerk-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Vetting Clerk</h3>
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                      @if(count($vettingClerk) > 0 )
                        @foreach($vettingClerk as $category)
                        <tr>
