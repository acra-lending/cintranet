    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="vert-tabs-tm-tools-tab" data-toggle="pill" href="#vert-tabs-tm-tools" role="tab" aria-controls="vert-tabs-tm-tools" aria-selected="false">TM Tools</a>
      ...
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-tm-tools" role="tabpanel" aria-labelledby="vert-tabs-tm-tools-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">TM Tools</h3>
                  <div class="card-tools">
                    </a>
                  </div>
                </div>
