<div class="tab-pane fade show" id="nav-post-close-shipping" role="tabpanel" aria-labelledby="nav-post-close-shipping-tab">
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-post-close-shipping-tab" data-toggle="pill" href="#vert-tabs-post-close-shipping" role="tab" aria-controls="vert-tabs-post-close-shipping" aria-selected="true">Post Close-Shipping</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          <div class="tab-pane text-left fade show active" id="vert-tabs-post-close-shipping" role="tabpanel" aria-labelledby="vert-tabs-post-close-shipping-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Post Close-Shipping</h3>
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                      @if(count($postCloseShipping) > 0 )
                        @foreach($postCloseShipping as $category)
                        <tr>
