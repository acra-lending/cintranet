<nav>
    ...
    <a class="nav-item nav-link" id="nav-fix-and-flip-tab" data-toggle="tab" href="#nav-fix-and-flip" role="tab" aria-controls="nav-fix-and-flip" aria-selected="false">Fix N Flip</a>
