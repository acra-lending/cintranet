<nav>
    ...
    <a class="nav-item nav-link" id="nav-doc-tab" data-toggle="tab" href="#nav-doc" role="tab" aria-controls="nav-doc" aria-selected="false">CD Doc Drawer</a>
    <a class="nav-item nav-link" id="nav-funder-tab" data-toggle="tab" href="#nav-funder" role="tab" aria-controls="nav-funder" aria-selected="false">Funder-Closer</a>
    ...
    <!-- <a class="nav-item nav-link" id="nav-valuations-tab" data-toggle="tab" href="#nav-valuations" role="tab" aria-controls="nav-valuations" aria-selected="false">Valuation Waterfall</a> -->
    ...
    <a class="nav-item nav-link" id="nav-fix-and-flip-tab" data-toggle="tab" href="#nav-fix-and-flip" role="tab" aria-controls="nav-fix-and-flip" aria-selected="false">ILD</a>
