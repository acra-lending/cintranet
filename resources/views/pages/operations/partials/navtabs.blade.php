<nav>
    ...
    <a class="nav-item nav-link" id="nav-valuations-tab" data-toggle="tab" href="#nav-valuations" role="tab" aria-controls="nav-valuations" aria-selected="false">Valuation Reviews</a>
