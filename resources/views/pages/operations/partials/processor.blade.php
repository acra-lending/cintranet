    ...
    <div class="row">
      <div class="col-sm-4 col-md-3 col-lg-3">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="vert-tabs-processor-vendor-contacts-tab" data-toggle="pill" href="#vert-tabs-processor-vendor-contacts" role="tab" aria-controls="vert-tabs-processor-vendor-contacts" aria-selected="true">Vendor Contacts</a>
        </div>
      </div>
      <div class="col-sm-12 col-md-9 col-lg-9">
        <div class="tab-content" id="vert-tabs-tabContent">
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-processor-tools" role="tabpanel" aria-labelledby="vert-tabs-processor-tools-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                  <h3 class="card-title">Processor Tools</h3>
                  <div class="card-tools">
                    </a>
                  </div>
                </div>
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($processorTools as $category)
                        <tr>
                          <td>{{$category->filename}}</td>
                          <td>{{$category->filesize}} KB</td>
                          <td>{{ Carbon\Carbon::parse($category->updated_at)->format('m-d-Y') }}</td>
          ...
          <div class="tab-pane text-left fade show" id="vert-tabs-processor-vendor-contacts" role="tabpanel" aria-labelledby="vert-tabs-processor-vendor-contacts-tab">
            <!-- /.content-header -->        
            <div class="col">
              <div class="card card-dark">
                <div class="card-header border-0">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table">
                    ...
                    <tbody>
                        @foreach($processorVendorContacts as $category)
                        <tr>
                          <td>{{$category->filename}}</td>
                          <td>{{$category->filesize}} KB</td>
                          <td>{{ Carbon\Carbon::parse($category->updated_at)->format('m-d-Y') }}</td>
