<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="nav-wholesale-tab" data-toggle="tab" href="#nav-wholesale" role="tab" aria-controls="nav-wholesale" aria-selected="true">Wholesale Forms</a>
        <a class="nav-item nav-link" id="nav-sbmf-tab" data-toggle="tab" href="#nav-sbmf" role="tab" aria-controls="nav-sbmf" aria-selected="false">Small Balance Multifamily</a>
