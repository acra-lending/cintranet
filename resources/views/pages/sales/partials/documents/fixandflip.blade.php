<div class="tab-pane fade" id="nav-fix-and-flip" role="tabpanel" aria-labelledby="nav-fix-and-flip-tab">
    <div class="row">
      <div class="col-sm-2">
        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="vert-tabs-fix-and-flip-tab" data-toggle="pill" href="#vert-tabs-fix-and-flip" role="tab" aria-controls="vert-tabs-retail-docs" aria-selected="true">Documents</a>
        </div>
      </div>
      <div class="col">
          <div class="card card-dark">
          <div class="card-header border-0">
              <h3 class="card-title">Fix & Flip</h3>
          ...
          <div class="card-body table-responsive p-0">
              ...
              <tbody>
                  @if(count($fixAndFlipDocs) > 0)
                  @foreach($fixAndFlipDocs as $category)
                  <tr>
