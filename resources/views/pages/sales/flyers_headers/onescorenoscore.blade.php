<div class="tab-pane text-left fade show active" id="vert-tabs-scorenoscore" role="tabpanel" aria-labelledby="vert-tabs-scorenoscore-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">One Score NO Score</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              ...
              @foreach($oneScorenoscore as $category)
                <tr>
