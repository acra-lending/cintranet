<div class="tab-pane text-left fade" id="vert-tabs-1099only" role="tabpanel" aria-labelledby="vert-tabs-1099only-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">1099 Only</h3>
