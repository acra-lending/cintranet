<div class="tab-pane text-left fade" id="vert-tabs-expandguid" role="tabpanel" aria-labelledby="vert-tabs-epandguid-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Expanding Guidence</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              ...
              @foreach($expandGuid as $category)
                <tr>
