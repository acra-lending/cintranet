                  ...
                  <div class="row">
                    <div class="col-sm-4 col-md-3">
                      <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="vert-tabs-social-videos-tab" data-toggle="pill" href="#vert-tabs-social-videos" role="tab" aria-controls="vert-tabs-social-videos" aria-selected="false">LinkedIn/Social Videos</a>
                    ...
                    <div class="col-sm-10 col-md-9">
                      <div class="tab-content" id="vert-tabs-tabContent">
                        ...
                        <div class="tab-pane fade" id="vert-tabs-corr" role="tabpanel" aria-labelledby="vert-tabs-corr-tab">        
                          ...
                          <div class="tab-pane fade" id="vert-tabs-social-videos" role="tabpanel" aria-labelledby="vert-tabs-social-videos-tab">        
                            <div class="col">
                              <div class="card card-danger">
                                <div class="card-header border-0">
                                  <h3 class="card-title">LinkedIn and Social Videos</h3>
                                  <div class="card-tools">
                                    </a>
                                  </div>
                                </div>
                                <div class="card-body table-responsive p-0">
                                  <table class="table">
                                    ...
                                    <tbody>
                                      @foreach($salesVideos as $category)
                                        <tr>
                                          <td>{{$category->filename}}</td>
                                          <td>{{$category->filesize}} KB</td>
                                          <td>{{ Carbon\Carbon::parse($category->created_at)->format('m-d-Y') }}</td>
