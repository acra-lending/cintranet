<div class="tab-pane text-left fade" id="vert-tabs-fundeal" role="tabpanel" aria-labelledby="vert-tabs-fundeal-tab">    
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Funded Deals</h3>
