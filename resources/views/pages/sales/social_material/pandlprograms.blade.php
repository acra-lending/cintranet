<div class="tab-pane text-left fade" id="vert-tabs-plprosm" role="tabpanel" aria-labelledby="vert-tabs-plprosm-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">P&L Programs</h3>
