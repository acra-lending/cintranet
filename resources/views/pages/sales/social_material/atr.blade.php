<div class="tab-pane text-left fade" id="vert-tabs-atrsm" role="tabpanel" aria-labelledby="vert-tabs-atrsm-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">ATR</h3>
