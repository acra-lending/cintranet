<div class="tab-pane text-left fade" id="vert-tabs-expandguildsm" role="tabpanel" aria-labelledby="vert-tabs-expandguildsm-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Expanding Guidelince</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              ...
              @foreach($expndGuidsm as $category)
                <tr>
