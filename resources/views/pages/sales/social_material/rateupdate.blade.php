<div class="tab-pane text-left fade" id="vert-tabs-rateupdate" role="tabpanel" aria-labelledby="vert-tabs-rateupdate-tab">    
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Rate Update</h3>
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
              ...
              @foreach($rateUpdate as $category)
                <tr>
