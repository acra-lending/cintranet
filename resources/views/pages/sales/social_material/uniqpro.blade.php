<div class="tab-pane text-left fade" id="vert-tabs-uniqprosm" role="tabpanel" aria-labelledby="vert-tabs-uniqprosm-tab">    
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Unique Properties</h3>
