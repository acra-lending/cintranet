<div class="tab-pane text-left fade" id="vert-tabs-smbfsm" role="tabpanel" aria-labelledby="vert-tabs-smbfsm-tab">    
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">SBMF</h3>
