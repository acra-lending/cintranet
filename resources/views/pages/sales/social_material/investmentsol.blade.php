<div class="tab-pane text-left fade" id="vert-tabs-invsolsm" role="tabpanel" aria-labelledby="vert-tabs-invsolsm-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Investment Solutions</h3>
