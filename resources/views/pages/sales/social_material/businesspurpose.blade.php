<div class="tab-pane text-left fade" id="vert-tabs-businesspurposesm" role="tabpanel" aria-labelledby="vert-tabs-businesspurposesm-tab">     
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Business Purpose</h3>
