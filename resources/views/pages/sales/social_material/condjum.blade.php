<div class="tab-pane text-left fade" id="vert-tabs-condjumsm" role="tabpanel" aria-labelledby="vert-tabs-condjumsm-tab">    
    <div class="col">
      <div class="card card-danger">
        <div class="card-header border-0">
          <h3 class="card-title">Condotel and Jumbo</h3>
