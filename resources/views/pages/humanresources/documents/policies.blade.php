<div class="tab-pane text-left fade show active" id="vert-tabs-policies" role="tabpanel" aria-labelledby="vert-tabs-policies-tab">      
    <div class="col">
        <div class="card card-dark">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table">
                    ...
                    <tbody>
                    @if(count($hrPolicies) > 0 )
                    @foreach($hrPolicies as $category)
                        <tr>
