<div class="tab-pane text-left fade show active" id="vert-tabs-guides" role="tabpanel" aria-labelledby="vert-tabs-guides-tab">      
    <div class="col">
        <div class="card card-dark">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table">
                    ...
                    <tbody>
                    @if(count($hrDayforceGuides) > 0 )
                    @foreach($hrDayforceGuides as $category)
                        <tr>
