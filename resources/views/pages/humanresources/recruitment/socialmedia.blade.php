<div class="tab-pane text-left fade show active" id="vert-tabs-social-media" role="tabpanel" aria-labelledby="vert-tabs-social-media-tab">
    <div class="col">
      <div class="card card-dark">
        ...
        <div class="card-body table-responsive p-0">
          <table class="table">
            ...
            <tbody>
                @if(count($hrSocialMedia) > 0 )
                @foreach($hrSocialMedia as $category)
                <tr>
