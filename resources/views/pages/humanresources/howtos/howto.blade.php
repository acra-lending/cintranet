<div class="tab-pane text-left fade show active" id="vert-tabs-how-to" role="tabpanel" aria-labelledby="vert-tabs-how-to-tab">
    <div class="col">
      <div class="card card-dark">
        <div class="card-header border-0">
          <h3 class="card-title">How To's</h3>
        </div>
