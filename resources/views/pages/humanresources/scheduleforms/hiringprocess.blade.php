<div class="tab-pane fade" id="vert-tabs-hiring-process" role="tabpanel" aria-labelledby="vert-tabs-hiring-process-tab">      
    <div class="col">
        <div class="card card-dark">
            <div class="card-header border-0">
            <h3 class="card-title">Hiring Process</h3>
            </div>
            <div class="card-body table-responsive p-0">
                <table class="table">
                    ...
                    <tbody>
                    @if(count($hrHiringProcess) > 0 )
                    @foreach($hrHiringProcess as $category)
                        <tr>
