<div class="tab-pane fade" id="vert-tabs-performance" role="tabpanel" aria-labelledby="vert-tabs-performance-tab">      
    <div class="col">
        <div class="card card-dark">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table">
                    ...
                    <tbody>
                    @if(count($hrPerformance) > 0 )
                    @foreach($hrPerformance as $category)
                        <tr>
